...
Login Mycat Magnage Interface
    ...
    Input Text    xpath=//*[contains(@text, '登入密碼')]    ${password}
...
Send Gift By Select User With ID
    ...
    Input Text After Click    //*[@resource-id='jp.naver.line.android:id/searchbar_input_text']    ${searchName}
...
Open Chrome
    ...
    Open Application    http://localhost:4723/wd/hub    platformName=Android    platformVersion=8.1.0    alias=MyChrome1
