...
def _connect_vpn_to_turkey_implenment(driver):
    try:
        ...
        _disconnect_vpn_implement(driver)
        WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.NAME, "Turkey")))
    WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.NAME, "連線"))).click()
    WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.NAME, "Turkey, Istanbul")))
