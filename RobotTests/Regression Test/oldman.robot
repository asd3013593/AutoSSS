...
${foreignTopic} =    0
${nextClientError} =    10
&{countryToVPN} =    日本=大阪 #39    印尼=雅加達 #8    韓國=首爾 #26    美國=紐約 #14    泰國=曼谷 #5    馬來西亞=吉隆波 #10    新加坡=新加坡 #20    香港=香港 #159
${globalCountry} =    日本
${currentLocation} =    台灣
${slowNetPeriod} =    30s
${LineApplication} =    1
...
...    clg42623    ysu99970    apa83781    ivy_0730    jt2589    zxc8899    lfu91092    asd58354    asd43578    xin920730
