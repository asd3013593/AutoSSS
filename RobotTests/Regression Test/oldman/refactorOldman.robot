...
# Resource    ./oldman.txt
# Resource    ${EXECDIR}/RobotTests/keywords/purchaseCoin.txt
# Suite Setup    Run Keywords    Set Library Search Order  AppiumLibrary  SeleniumLibrary
# ...                     AND    Login Oldman Magnage Page
# Suite Teardown    Application::Close All Application And Back To Home
...
# Automatically send taiwan sticker oldman
    # [Setup]    Go To Taiwan Sticker Sending Page
    # Sending Taiwan Sticker And Topic To Client
    # [Teardown]    Wait Until All Order Is Finish
...
# # Login Magnage Page With Chrome
    ...
    # # Mangage Page::Login Magnage Page    ${user.url}    ${user.accound}    ${user.password}
...
# # If Name Is Not Equal To ID Change Name To ID
    ...
    # # Run Keyword If    not ${equalTo}    Application::Change User Name To Id
